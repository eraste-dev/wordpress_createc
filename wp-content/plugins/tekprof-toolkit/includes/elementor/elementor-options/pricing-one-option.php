...
$repeater->add_control(
	...
	[
		...
		'default' => [
			[
				'layout_one_feature_text' => esc_html__('Custom software development', 'tekprof-toolkit'),
			],
			[
				'layout_one_feature_text' => esc_html__('Requirement analysis & planning', 'tekprof-toolkit'),
			],
			[
				'layout_one_feature_text' => esc_html__('Support and maintenance', 'tekprof-toolkit'),
			],
			[
				'layout_one_feature_text' => esc_html__('Integration third-party services', 'tekprof-toolkit'),
			],
			[
				'layout_one_feature_text' => esc_html__('Data backups and advanced', 'tekprof-toolkit'),
			],
			[
				'layout_one_feature_text' => esc_html__('Analytics and reporting features', 'tekprof-toolkit'),
			],
		],
...
$this->add_control(
	...
	[
		...
		'default' => [
			[
				'layout_one_package_title' => esc_html__('Starter Package', 'tekprof-toolkit'),
				'layout_one_package_description' => esc_html__('Small businesses and startups', 'tekprof-toolkit'),
				'layout_one_price' => esc_html__('$5,000', 'tekprof-toolkit'),
				'layout_one_duration' => esc_html__('/per month', 'tekprof-toolkit'),
				'layout_one_is_popular' => 'no',
			],
			[
				'layout_one_package_title' => esc_html__('Enterprise Package', 'tekprof-toolkit'),
				'layout_one_package_description' => esc_html__('Large businesses and requirements', 'tekprof-toolkit'),
				'layout_one_price' => esc_html__('$30,000', 'tekprof-toolkit'),
				'layout_one_duration' => esc_html__('/per month', 'tekprof-toolkit'),
				'layout_one_is_popular' => 'yes',
			],
			[
				'layout_one_package_title' => esc_html__('Custom Package', 'tekprof-toolkit'),
				'layout_one_package_description' => esc_html__('Businesses with unique, large-scale', 'tekprof-toolkit'),
				'layout_one_price' => esc_html__('$75,000', 'tekprof-toolkit'),
				'layout_one_duration' => esc_html__('/per month', 'tekprof-toolkit'),
				'layout_one_is_popular' => 'no',
			],
		],
...
$yearly_repeater->add_control(
	...
	[
		...
		'default' => [
			[
				'layout_one_yearly_feature_text' => esc_html__('Custom software development', 'tekprof-toolkit'),
			],
			[
				'layout_one_yearly_feature_text' => esc_html__('Requirement analysis & planning', 'tekprof-toolkit'),
			],
			[
				'layout_one_yearly_feature_text' => esc_html__('Support and maintenance', 'tekprof-toolkit'),
			],
			[
				'layout_one_yearly_feature_text' => esc_html__('Integration third-party services', 'tekprof-toolkit'),
			],
			[
				'layout_one_yearly_feature_text' => esc_html__('Data backups and advanced', 'tekprof-toolkit'),
			],
			[
				'layout_one_yearly_feature_text' => esc_html__('Analytics and reporting features', 'tekprof-toolkit'),
			],
			[
				'layout_one_yearly_feature_text' => esc_html__('Priority support 24/7', 'tekprof-toolkit'),
			],
		],
...
$this->add_control(
	...
	[
		...
		'default' => [
			[
				'layout_one_yearly_package_title' => esc_html__('Starter Package', 'tekprof-toolkit'),
				'layout_one_yearly_package_description' => esc_html__('Small businesses and startups', 'tekprof-toolkit'),
				'layout_one_yearly_price' => esc_html__('$50,000', 'tekprof-toolkit'),
				'layout_one_yearly_duration' => esc_html__('/per year', 'tekprof-toolkit'),
				'layout_one_yearly_is_popular' => 'no',
			],
			[
				'layout_one_yearly_package_title' => esc_html__('Enterprise Package', 'tekprof-toolkit'),
				'layout_one_yearly_package_description' => esc_html__('Large businesses and requirements', 'tekprof-toolkit'),
				'layout_one_yearly_price' => esc_html__('$700,00', 'tekprof-toolkit'),
				'layout_one_yearly_duration' => esc_html__('/per year', 'tekprof-toolkit'),
				'layout_one_yearly_is_popular' => 'yes',
			],
			[
				'layout_one_yearly_package_title' => esc_html__('Custom Package', 'tekprof-toolkit'),
				'layout_one_yearly_package_description' => esc_html__('Businesses with unique, large-scale', 'tekprof-toolkit'),
				'layout_one_yearly_price' => esc_html__('$950,00', 'tekprof-toolkit'),
				'layout_one_yearly_duration' => esc_html__('/per year', 'tekprof-toolkit'),
				'layout_one_yearly_is_popular' => 'no',
			],
		],
