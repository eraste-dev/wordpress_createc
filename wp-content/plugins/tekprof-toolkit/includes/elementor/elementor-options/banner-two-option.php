...
$this->add_control(
	...
	[
		...
		'type' => \Elementor\Controls_Manager::TEXTAREA,
		'default' => esc_html__('Let me know if any of these resonate or if you have a specific focus area I should incorporate!', 'tekprof-toolkit'),
		'label_block' => true,
	]
);

$this->add_control(
	'banner_two_button_text',
	[
...
$this->add_control(
	'banner_two_image',
	[
		'label' => esc_html__('Hero Image', 'tekprof-toolkit'),
