<?php if ('layout_three' == $settings['layout_type']) : ?>
    ...
    <section class="case-studies-area pt-130 rpt-100 pb-100 rpb-70 rel z-1">
        <div class="container">
                            ...
                            <div class="case-study-item">
                                ...
                                <div class="content">
                                    <?php if (!empty($categories_list[0]->name) && 'yes' === $settings['show_category']) : ?>
                                        <a href="<?php echo esc_url(get_category_link($categories_list[0]->term_id)); ?>" class="tag"><?php echo esc_html($categories_list[0]->name); ?></a>
                                    <?php endif; ?>
                                    ...
                                    <a href="<?php the_permalink(); ?>" class="theme-btn mt-15"><?php echo esc_html($settings['read_more']); ?></a>
                                </div>
                            </div>
                        </div>
                <?php
                            ...
                            ?>
                                <div class="col-xl-4 col-md-6" data-aos="fade-up" data-aos-delay="200" data-aos-duration="1500" data-aos-offset="50">
                                    <div class="case-study-item">
                                        ...
                                        <div class="content">
                                            <?php if (!empty($categories_list[0]->name) && 'yes' === $settings['show_category']) : ?>
                                                <a href="<?php the_permalink(); ?>" class="tag"><?php echo esc_html($categories_list[0]->name); ?></a>
                                            <?php endif; ?>
                                            <<?php echo rt_escape_tags($settings['title_tag']); ?> class="title">
                                            ...
                                            <a href="<?php the_permalink(); ?>" class="theme-btn mt-15"><?php echo esc_html($portfolio['read_more']); ?></a>
                                        </div>
                                    </div>
                                </div>
                    <?php
