...
define('DUPLICATOR_PRO_VERSION', '4.5.22.5');
...
define('DUPLICATOR_PRO_GEN_FILE_REGEX_PATTERN', '/^(.+_[a-z0-9]{7,}_[0-9]{14})_.+\\.(?:zip|daf|php|bak)$/');
// MATCH all file related to the package, archive installer and log
define('DUPLICATOR_PRO_FULL_GEN_BACKUP_FILE_REGEX_PATTERN', '/^(.+_[a-z0-9]{20}_[0-9]{14})_.+\\.(?:zip|daf|php|bak|txt|sql|json)$/');
...
$GLOBALS['DUPLICATOR_PRO_OPTS_DELETE'] = array(
    'duplicator_pro_ui_view_state',
...
if (!defined('DUPLICATOR_PRO_INDEX_INCLUDE_HASH')) {
    define('DUPLICATOR_PRO_INDEX_INCLUDE_HASH', false);
}

if (!defined('DUPLICATOR_PRO_INDEX_INCLUDE_INSTALLER_FILES')) {
    define('DUPLICATOR_PRO_INDEX_INCLUDE_INSTALLER_FILES', false);
}
...
if (!defined('DUPLICATOR_PRO_PRIMARY_OAUTH_SERVER')) {
    define('DUPLICATOR_PRO_PRIMARY_OAUTH_SERVER', 'https://connect.duplicator.com');
}
if (!defined('DUPLICATOR_PRO_SECONDARY_OAUTH_SERVER')) {
    define('DUPLICATOR_PRO_SECONDARY_OAUTH_SERVER', 'https://connect2.duplicator.com');
}
